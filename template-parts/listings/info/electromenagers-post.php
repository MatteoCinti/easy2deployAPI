...
<?php if( function_exists( 'pll_current_language' ) ){ ?> 
  ...
  <?php if( pll_current_language('slug') === 'fr' ){ ?>
    ...
    <div class="details electromenagers">
      <div class="section-title"><h3> Electromenagers </h3></div>
      <div class="section-details">
        ...
        <?php  if( $equipements['micro_ondes'] === true ){ ?>
          <div class="detail">
            <i class="fas fa-water"></i><h5 class="label checker-label">Microondes</h5>
          </div>
        <?php } ?>
        ...
        <?php  if( $equipements['refrigerateur'] === true ){ ?>
          <div class="detail">
            <i class="fas fa-thermometer-empty"></i><h5 class="label checker-label">Réfrigerateur</h5>
          </div>
        <?php } ?>
